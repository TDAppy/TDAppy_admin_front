          ...
          (i.prototype.handleMouseWheel = function (t) {
            if (this.options.zoomEnabled && 'none' === this.state) {
              ...
              ((this.lastMouseWheelEventTime = Date.now()),
                ...
                (e =
                  -0.3 < e && e < 0.3 ? e : ((0 < e ? 1 : -1) * Math.log(Math.abs(e) + 10)) / n));
                ...
                (this.publicInstance = this.pi =
                  {
                    ...
                    setOnPan: function (t) {
                      return (
                        (o.options.onPan = null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    enableZoom: function () {
                    ...
                    setOnZoom: function (t) {
                      return (
                        (o.options.onZoom = null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    zoom: function (t) {
        ...
        function i(t, e, o, n) {
          ...
          ((i =
            'wheel' === l
              ? o
              : (function (t) {
                  for (var e = 0; e < h.length; e++) if (h[e].element === t) return h[e].fn;
                  return function () {};
                })(t)),
            t[a](u + e, i, n ? c : p),
            (function (t) {
              for (var e = 0; e < h.length; e++) if (h[e].element === t) return h.splice(e, 1);
            })(t));
        }
        var r, a, l, u, h, c, p;
        e.exports =
          ...
          {
            on: function (t, e, o) {
              (n(t, l, e, o), 'DOMMouseScroll' == l && n(t, 'MozMousePixelScroll', e, o));
            },
            off: function (t, e, o) {
              (i(t, l, e, o), 'DOMMouseScroll' == l && i(t, 'MozMousePixelScroll', e, o));
            },
          });
      },
      {},
